    ...
    return {
        ...
        link: function (scope, element, attrs, $window) {
            element.bind("click", function () {
                ...
                if (current) {
                    cuurentdom.siblings('.static').addClass("hide-device-promortion");
                    cuurentdom.siblings('.dymanic').removeClass("hide-device-promortion");
                    cuurentdom.siblings('.view-less').removeClass("hide-device-promortion");
                    cuurentdom.addClass("hide-device-promortion");
                } else {
                    cuurentdom.siblings('.static').removeClass("hide-device-promortion");
                    cuurentdom.siblings('.dymanic').addClass("hide-device-promortion");
