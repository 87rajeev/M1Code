(function () {
    ...
    /*angular.module("m1cp.core").controller("ContactusController1",["$scope", function ($scope) {
    }]);

    //Angular Controller Definition Reference2 and Dependency Should be Injected Using $inject
    angular.module("m1cp.core").controller("ContactusController2", ContactusController2);
