namespace M1CP.Foundation.AssetsIncludes.Repositories
{
    using System;
    ...
    public class AssetRepository: RepositoryBase
    {
        ...
        public Asset AddInlineScript(Item item, ScriptLocation location, bool preventAddToCache)
        {
        string script = ScContext.Cast<AssertModel>(item).scriptIncludes;
        ...
        public Asset AddGAScript(Item item, ScriptLocation location, bool preventAddToCache)
        {
            string script = ScContext.Cast<AssertModel>(item).gaIncludes;
        ...
        public Asset AddInlineStyling(Item styling, bool preventAddToCache)
        {
            string style = ScContext.Cast<AssertModel>(styling).cssIncludes;
            ...
            {
                return this.AddAsset(style, ScriptLocation.Head, preventAddToCache, AssetType.Css, AssetContentType.Inline);
            }
        }
