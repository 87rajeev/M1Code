...
// ***********************************************************************
// <copyright file="ContestSubmissionFilter.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Filters
{
    ...
    public class ContestSubmissionFilter : BaseFilter
    {
        /// <summary>
        ...
        {
            var logElement = element as ContestSubmission;
            DateTime dateCreated = Convert.ToDateTime(logElement.SubmissionDate);
