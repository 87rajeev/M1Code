...
// ***********************************************************************
// <copyright file="MegadealsROIScanner.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Scanners
{
    ...
    public class MegadealsROIScanner : ASR.Interface.BaseScanner
    {
        /// <summary>
        ...
        public override ICollection Scan()
        {
            ...
            var items = helper.FillDataSet<MegadealsROI>(Constants.MegadealsROI);
            return items;
        }
    }
}