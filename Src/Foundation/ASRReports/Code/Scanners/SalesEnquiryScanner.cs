...
// ***********************************************************************
// <copyright file="SalesEnquiryScanner.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Scanners
{
    ...
    public class SalesEnquiryScanner : ASR.Interface.BaseScanner
    {
        /// <summary>
        ...
        public override ICollection Scan()
        {
            ...
            var items = helper.FillDataSet<SalesEnquiry>(Constants.SalesEnquiry);
            return items;
        }
    }
}