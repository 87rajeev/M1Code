...
// ***********************************************************************
// <copyright file="UnSubscribeDigiCampScanner.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Scanners
{
    ...
    public class UnSubscribeDigiCampScanner : ASR.Interface.BaseScanner
    {
        /// <summary>
        ...
        public override ICollection Scan()
        {
            ...
            var items = helper.FillDataSet<UnSubscribeDigiCamp>(Constants.UnSubscribeDigiCamp);
            return items;
        }
    }
}