...
// ***********************************************************************
// <copyright file="M1SearchTermScanner.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Scanners
{
    ...
    public class M1SearchTermScanner : ASR.Interface.BaseScanner
    {
        /// <summary>
        ...
        public override ICollection Scan()
        {
            ...
            var items = helper.FillDataSet<M1SearchTerm>(Constants.M1SearchTerm);
            return items;
        }
    }
}