...
// ***********************************************************************
// <copyright file="MegadealsROIViewer.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Viewers
{
    ...
    public class MegadealsROIViewer : BaseViewer
    {
        /// <summary>
        ...
        public override string[] AvailableColumns
        {
            get
            {
                MegadealsROI logElement = new MegadealsROI();
        ...
        public override void Display(DisplayElement dElement)
        {
            ...
            helper.BindDisplay<MegadealsROI>(dElement, Columns);
        }
    }
}