...
// ***********************************************************************
// <copyright file="HBBInterestViewer.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Viewers
{
    ...
    public class HBBInterestViewer : BaseViewer
    {
        /// <summary>
        ...
        public override string[] AvailableColumns
        {
            get
            {
                HBBInterest logElement = new HBBInterest();
        ...
        public override void Display(DisplayElement dElement)
        {
            ...
            helper.BindDisplay<HBBInterest>(dElement, Columns);
        }
