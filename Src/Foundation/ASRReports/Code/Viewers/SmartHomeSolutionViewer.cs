...
{
    public class SmartHomeSolutionViewer : BaseViewer
    {
        public override string[] AvailableColumns
        {
            get
            {
                SmartHomeSolution logElement = new SmartHomeSolution();
        ...
        public override void Display(DisplayElement dElement)
        {
            ...
            SmartHomeSolution logElement =
                dElement.Element as SmartHomeSolution;
            int _increase = 0;
            if (logElement != null)
            {
