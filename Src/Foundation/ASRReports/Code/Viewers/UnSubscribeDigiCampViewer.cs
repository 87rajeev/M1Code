...
// ***********************************************************************
// <copyright file="UnSubscribeDigiCampViewer.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace M1CP.Foundation.ASRReports.Viewers
{
    ...
    public class UnSubscribeDigiCampViewer : BaseViewer
    {
        /// <summary>
        ...
        public override string[] AvailableColumns
        {
            get
            {
                UnSubscribeDigiCamp logElement = new UnSubscribeDigiCamp();
        ...
        public override void Display(DisplayElement dElement)
        {
            ...
            helper.BindDisplay<UnSubscribeDigiCamp>(dElement, Columns);
        }
    }
}