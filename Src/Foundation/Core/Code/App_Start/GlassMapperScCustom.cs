...
using M1CP.Foundation.GlassMapper.Handler;
using IDependencyResolver = Glass.Mapper.Sc.IoC.IDependencyResolver;

namespace M1CP.Foundation.Base.App_Start
{
    public static  class GlassMapperScCustom
    {
		public static IDependencyResolver CreateResolver(){
            ...
            dependencyResolver.DataMapperFactory.Insert(8, () => new SitecoreFieldCustomImageMapper());
