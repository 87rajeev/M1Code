...
using M1CP.Foundation.Dictionary.Services;
...
namespace M1CP.Foundation.Dictionary.Repositories
{
    ...
    {
        public M1CP.Foundation.Dictionary.Models.Dictionary Dictionary { get; set; }

        public DictionaryPhraseRepository(M1CP.Foundation.Dictionary.Models.Dictionary dictionary)
        {
