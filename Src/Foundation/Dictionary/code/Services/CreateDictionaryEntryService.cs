...
namespace M1CP.Foundation.Dictionary.Services
{
    internal static class CreateDictionaryEntryService
    {

        public static Item CreateDictionaryEntry(M1CP.Foundation.Dictionary.Models.Dictionary dictionary, string relativePath, string defaultValue)
        {
            lock (dictionary)
            {
